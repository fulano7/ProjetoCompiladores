...
public class Helper {
  ...
  public static final String EXCLUSION_FILE = RESOURCES_DIR
      + "/ExclusionAllJava.txt";
  public static final String EXCLUSION_FILE_FOR_CALLGRAPH = RESOURCES_DIR
      + "/ExclusionForCallGraph.txt";
  ...
  private static String getCurrentTestName() {
    ...
    String testName = stackTrace[3].getClassName().replace(".", "/") + "."
