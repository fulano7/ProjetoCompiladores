...
public class EditarFuncionarioFrame extends JFrame {
		...
		btnAtualizarDados.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					JOptionPane.showMessageDialog(EditarFuncionarioFrame.this,
							"Selecione um Funcionario:");
				}
				AtualizarFuncionarioFrame frame = new AtualizarFuncionarioFrame(
						(Funcionario) p);
				frame.setVisible(true);
			}
		});
