...
public class AtualizarFuncionario extends JFrame {
	...
	public AtualizarFuncionario() {
		...
		lblDigiteOCpf = new JLabel("Digite o CPF do funcionário:");
				...
				try {
					if(tf_cpf.getText().equals("")){
						...
						JTextArea textArea = new JTextArea(6, 25);			
					      ...
					      JOptionPane.showMessageDialog(null, scrollPane, "Atualização",JOptionPane.INFORMATION_MESSAGE);
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							fachada.atualizarInfoFuncionario(passwordField.getText(), tf_cpf.getText(), tf_nome.getText(),
									1);
							JOptionPane.showMessageDialog(null, "O nome do funcionário foi atualizado com sucesso!");
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							fachada.atualizarInfoFuncionario(passwordField.getText(), tf_cpf.getText(), tf_rua.getText(),
									2);
							JOptionPane.showMessageDialog(null,"A rua do funcionário foi atualizada com sucesso!");
							try { // Isto serve para fechar a janela
								internalFrame.setClosed(true);
							} catch (PropertyVetoException a) {
								// TODO Auto-generated catch block
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							fachada.atualizarInfoFuncionario(passwordField.getText(), tf_cpf.getText(), tf_numero.getText(),
									3);
							JOptionPane.showMessageDialog(null,"O Número da residência do funcionário foi atualizado com sucesso!");
							try { // Isto serve para fechar a janela
								internalFrame.setClosed(true);
							} catch (PropertyVetoException a) {
								// TODO Auto-generated catch block
					...
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							fachada.atualizarInfoFuncionario(passwordField.getText(), tf_cpf.getText(), tf_complemento.getText(),
									4);
							JOptionPane.showMessageDialog(null,"O complemento do endereço do Funcionário foi atualizado com sucesso!");
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							fachada.atualizarInfoFuncionario(passwordField.getText(), tf_cpf.getText(), tf_cep.getText(),
									5);
							JOptionPane.showMessageDialog(null, "O cep do funcionário foi atualizado com sucesso!");
							try { // Isto serve para fechar a janela
								internalFrame.setClosed(true);
							} catch (PropertyVetoException a) {
								// TODO Auto-generated catch block
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							fachada.atualizarInfoFuncionario(passwordField.getText(), tf_cpf.getText(), tf_telefone.getText(),
									6);
							JOptionPane.showMessageDialog(null, "O telefone do funcionário foi atualizado com sucesso!");
							try { // Isto serve para fechar a janela
								internalFrame.setClosed(true);
							} catch (PropertyVetoException a) {
								// TODO Auto-generated catch block
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							fachada.atualizarInfoFuncionario(passwordField.getText(), tf_cpf.getText(), tf_senha.getText(),
									7);
							JOptionPane.showMessageDialog(null, " A senha do funcionário foi redefinida com sucesso!");
							try { // Isto serve para fechar a janela
								internalFrame.setClosed(true);
							} catch (PropertyVetoException a) {
								// TODO Auto-generated catch block
