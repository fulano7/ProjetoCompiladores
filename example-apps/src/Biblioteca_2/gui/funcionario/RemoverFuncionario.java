...
public class RemoverFuncionario extends JFrame {
	...
	public RemoverFuncionario() {
		...
		this.setTitle("Remover Funcionário");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if(tf_cpf.getText().equals("") || passwordField.getText().equals("")){
						...
						RemoverFuncionario.this.dispose();
						Login frame = new Login();
						frame.setVisible(true);
						
					}else{
					fachada.realizarExclusaoFuncionario(passwordField.getText());
					RemoverFuncionario.this.dispose();
		...
		rdbtnSim.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					fachada.confirmarExclusaoFuncionario(tf_cpf.getText());
