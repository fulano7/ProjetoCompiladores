...
import dados.repositorio.array.RepositorioPessoaArray;
import dados.repositorio.array.RepositorioLivroArray;
import dados.repositorio.array.RepositorioSalaArray;
import dados.repositorio.lista.RepositorioLivroLista;
import dados.repositorio.lista.RepositorioPessoaLista;
import dados.repositorio.lista.RepositorioSalaLista;
...
import negocios.exceptions.pessoa.*;
...
public class Principal {
	...
	public String carregarConfig() throws FileNotFoundException,
		...
		String nomeArqEnt = "C:\\Users\\CaioCalado\\Dropbox\\UFPE\\Ciência da Computação\\Ciência da Computação 2012.2\\if-669\\Projeto - IP\\Biblioteca_2\\CONFIG.txt";
		...
		// retirando os espaços vazios que antecedem o tipo do repositorio
		while (repositorio.length() > 0 && repositorio.charAt(0) == ' ') {
			repositorio = repositorio.substring(1, repositorio.length());
		}

		// retirando os espaços vazios que sucedem o tipo do repositorio
	...
	public void realizarEmprestimoLivro(String cpf, String senha, String codigo)
		...
		mPessoa.confirmarSenhaAluno(senha); // Verificação do aluno
